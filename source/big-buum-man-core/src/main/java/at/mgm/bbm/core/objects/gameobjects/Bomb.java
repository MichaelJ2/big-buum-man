...
public class Bomb extends DisplayObject {
    ...
    public static final int TIMER_DEFAULT = 2000;
    ...
    public Bomb(final Player paramPlayer) {
        super(GameObjectType.BOMB, paramPlayer.x, paramPlayer.y, paramPlayer.bombRange);
        this.timerInMillis = paramPlayer.bombTimer;
