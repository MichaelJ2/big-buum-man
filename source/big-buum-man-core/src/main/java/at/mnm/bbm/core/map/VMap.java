...
import at.mnm.bbm.core.events.Event;
import at.mnm.bbm.core.objects.fields.Field;
import at.mnm.bbm.core.objects.fields.FieldType;
import at.mnm.bbm.core.objects.fields.FieldFactory;
...
public enum VMap {
    ...
    public synchronized boolean triggerEvent(final Event paramEvent) {
        boolean success = false;
        final int X = paramEvent.getX();
        final int Y = paramEvent.getY();
